        ...
        <div>
            <section className="project__grid"> 
                ...
                <div>
                    ...
                    and will have the option to join. Once the user has joined the game, they will be able to view other players
                    who are currently playing. When the user is finished playing, they will be able to submit their score on the leaderboard.
                    </p>
                    <p className="project__description">
                        ...
                        user authentication, alerts, mobile design, and css styles.
                    </p>
                </div>
                ...
                <div>
                    ...
                    Start the game with $5,000 in the bank, once the player is finished with playing the game, 
                    ...
                    <p className="project__description">
                    Group Project: Mainly responsible for creating the front-end of the application,
                    implementing handlebars, and integrating the functionality from the back-end
                     to the front-end.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="project__description">Project Description: 
                    A web application that allows users to quickly display recipes from a recipe API in different ways that
